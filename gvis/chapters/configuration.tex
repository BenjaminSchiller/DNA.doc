...
The GraphPanelConfig is a configuration object for a GraphPanel. It contains the most general configurable aspects as well as additional configuration objects, namely a \emph{WaitConfig}, \emph{ProjectionConfig}, \emph{RulesConfig} and a \emph{CaptureConfig}. The general configuration structure is shown in figure \ref{fig:configstruct}.
